    ...
    >
      ...
      >
        <Typography
          ...
          sx={{ fontWeight: "600" }}
        >
          Manage Travel Blog Sub-Categories
        </Typography>
      </Box>
                ...
                <TableBody>
                  {subcategories.map((subcategory) => (
                    <StyledTableRow key={subcategory._id}>
                      ...
                      <StyledTableCell>
                        {subcategory?.category?.category || "N/A"}
                      </StyledTableCell>
                      <StyledTableCell>
                        <IconButton
                          aria-label="edit"
                          onClick={() =>
                            handleEditItem(subcategory._id, "subcategory")
                          }
                          size="small"
                          sx={{ color: "#1976d2" }}
                        >
                        ...
                        <IconButton
                          aria-label="delete"
                          onClick={() =>
                            handleDeleteItem(subcategory._id, "subcategory")
                          }
                          size="small"
                          sx={{ color: "#d32f2f" }}
                        >
